...
class Scrollvideo_Meta_Boxes {
    ...
    public static function render_settings_box( $post ) {
        ...
        <table class="form-table sv-meta-table">
            ...
            <tr>
                <th><label for="sv_start_point"><?php esc_html_e( 'Scroll Start', 'scrollvideo' ); ?></label></th>
                <td>
                    <input type="text" id="sv_start_point" name="sv_start_point"
                           value="<?php echo esc_attr( $start_point ); ?>"
                           class="regular-text" />
                    <p class="description"><?php esc_html_e( 'Scroll start value, e.g. "top top", "top center".', 'scrollvideo' ); ?></p>
                </td>
            </tr>
            <tr>
                <th><label for="sv_end_point"><?php esc_html_e( 'Scroll End', 'scrollvideo' ); ?></label></th>
                <td>
                    <input type="text" id="sv_end_point" name="sv_end_point"
                           value="<?php echo esc_attr( $end_point ); ?>"
                           class="regular-text" />
                    <p class="description"><?php esc_html_e( 'Scroll end value, e.g. "bottom bottom", "bottom center".', 'scrollvideo' ); ?></p>
                </td>
            </tr>
        </table>
        <?php
